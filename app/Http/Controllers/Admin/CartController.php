...
class CartController extends Controller
{
    ...
    public function add(Product $product, Request $req)
    {
        ...
        return redirect()->back('no', 'Something error, please try again');
    }
    ...
    public function delete($product_id)
    {
        ...
        return redirect()->back()->with('ok', 'Deleted product successfully');
    }
    public function clear()
    {
        ...
        return redirect()->back()->with('ok', 'Deleted all product successfully');
    }
