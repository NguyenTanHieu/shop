...
@section('main')
    <form action="" method="post" class="form-inline" role="form">
        ...
        <a href="{{ route('tag_product.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add new</a>
    </form>
        ...
        <tbody>
            @foreach ($tags as $index => $tag)
                <tr>
                    ...
                    <td class="text-right">
                        <form action="{{ route('tag_product.destroy', $tag->id) }}" method="post">
                            @csrf @method('delete')
                            <a href="{{ route('tag_product.edit', $tag->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
