...
<head>
    ...
    <style>
        .top-search .search-ajax-result {
            position: absolute;
            background-color: #fff;
            padding: 10px;
        }

        .top-search .search-ajax-result h4 {
            font-size: 16px;
            font-weight: normal;
			text-align: left
        }

        .top-search .search-ajax-result .media-body {
            text-align: left;
        }

        .top-search .search-ajax-result p {
            font-size: 14px;
            font-style: italic;
        }
    </style>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-5">
                    <ul class="top-bar-contacts">
                        ...
                        <li class="mail"><i class="fa fa-envelope-o" aria-hidden="true"></i>orders@mistercoffee.us
                        </li>
                ...
                <div class="col-md-6 col-sm-7 ">
                    <ul class="top-bar-contacts">
                        @if (auth('cus')->check())
                            <li><a href="{{ route('account.profile') }}"style="color:black">Hi
            ...
            <div class="container">
                <div class="row position-relative">
                    <div class="col-lg-1 col-md-1">
                        <a href="{{ route('home.index') }}" class="small-logo alt"><img
                                src="assets/images/TH-LOGO-SMALL.png" alt=""></a>
                    </div>
                                    ...
                                    <li class="parent"><a href="where.html">Category</a>
                                        <ul class="sub-menu">
                                            @foreach ($cats_home as $cath)
                                                <li><a href="{{ route('home.category', ['cat'=>$cath->id,'slug'=>$cath->slug]) }}">{{ $cath->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    ...
                                    <li class="parent">
                                        ...
                                        <ul class="sub-menu">
                                            @foreach ($cats_home_post as $cathp)
                                                <li><a
                                                        href="{{ route('home.category_post', $cathp->id) }}">{{ $cathp->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                            ...
                            <div class="col-lg-3 col-md-12">
                                <div class="top-right">
                                    ...
                                    <div class="top-search">
                                        ...
                                        <input type="text" class="input-search-ajax" placeholder="Search ">
                    ...
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                        data-target="#coffee-menu" aria-expanded="false">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-2 col-sm-6">
                        <a href="#" class="footer-logo"><img src="assets/images/footer-logo.png"
                                alt=""></a>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="footer-about">
                            <div class="title">About Mr.Coffee</div>
                            <p>Sed sagittis sodales lobortis. Curabitur in eleifend<br> turpis, id vehicula odio. Donec
                                pulvinar tellus<br> eget magna aliquet ultricies. </p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="copyrights"><a href="#">Copy</a> 2024 &copy; All Rights reserved <a
                                href="#">By NTH</a></div>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    for (var pro of res) {
                        ...
                        // _html += '    <a href="{{ url('product') }}/' + pro.id + '-' + pro.slug + '" class="pull-left">';
                        // _html += '        <img class="media-object" width="50" src="' + _url + '/' + pro.image + '">';
                        // _html += '    </a>';
                        // _html += '    <div class="media-body">';
                        // _html += '        <h4 class="media-heading">';
                        // _html += '            <a href="{{ url('product') }}/' + pro.id + '-' + pro.slug + '">' + pro.name + '</a>';
                        // _html += '        </h4>';
                        // _html += '        <p>' + pro.description + '</p>';
                        // _html += '    </div>';
                        // _html += '</div>';
                    }
