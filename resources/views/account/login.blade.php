                    ...
                    <div class="contact-right">
                        ...
                        <form class="contact-form" action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input name="email" class="contact-input" type="email" placeholder="Email *"
                                        required>
                                    @error('email')
                                ...
                                <div class="col-md-12">
                                    <input name="password" class="contact-input" type="text"
								...
								<div class="col-md-12 text-center" style="margin-top:20px">
									<a href="{{ route('account.register') }}">Click here to create account</a>
								</div>
								<div class="col-md-12 text-center" style="margin-top:20px">
