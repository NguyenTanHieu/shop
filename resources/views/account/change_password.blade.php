				...
				<div class="contact-right">
					...
					<form class="contact-form" action="" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<input name="old_password" class="contact-input" type="text" placeholder="Old password *" required>
								@error('old_password')
							...
							<div class="col-md-12">
								<input name="confirm_password" class="contact-input" type="text" placeholder="Confirm password *" required>
